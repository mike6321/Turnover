...
public class CheatActivity extends AppCompatActivity {
    // Member Variable
    // set key
    private static final String EXTRA_ANSWER_IS_TRUE = "com.example.joguk.geoquizguk.answer_is_true";
    private static final String EXTRA_ANSWER_SHOWN = "com.example.joguk.geoquizguk.answer_shown";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mNoThanksButton = (Button) findViewById(R.id.show_answer_button);
